...
help_string = '''
<b><a href='https://github.com'>Cloud Succc</a></b> - Yet another Telegram Mirrorbot:
'''
...
def bot_help(update, context):
    button = ButtonMaker()
    if EMOJI_THEME is True:
        button.buildbutton("Userr", f"https://graph.org/{help_user}")
        button.buildbutton("Adminn", f"https://graph.org/{help_admin}")
    else:
