...
try:
    ...
    TGH_THUMB = 'https://graph.org/file/a6c5b9e0992d9bdad905b.jpg'
...
try:
    ...
    START_BTN1_URL = 'https://github.com/okAxL'
...
try:
    ...
    START_BTN2_NAME = 'me'
    START_BTN2_URL = 'https://t.me/screwie69'
try:
...
try:
    ...
    if len(AUTHOR_URL) == 0:
        AUTHOR_URL = 'https://t.me/screwie69'
except KeyError:
    AUTHOR_URL = 'https://t.me/screwie69'
try:
    TITLE_NAME = getConfig('TITLE_NAME')
    if len(TITLE_NAME) == 0:
        TITLE_NAME = 'Cloud Succc'
except KeyError:
    TITLE_NAME = 'Cloud Succc'
...
try:
    ...
    log_info("CHANNEL_USERNAME not provided! Using default @Screwie69")
    CHANNEL_USERNAME = "Cloud Succc"
try:
    ...
    log_info("CHANNEL_ID not provided! Using default id of @Screwie69")
    FSUB_CHANNEL_ID = -6969699669
try:
...
try:
    ...
    IMAGE_URL = 'https://graph.org/file/a6c5b9e0992d9bdad905b.jpg'
try:
